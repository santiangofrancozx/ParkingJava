    ...
    public ObjetoIngreso ValidarFormato() {
        ...
        if (bloques.length == 5) {
            ...
            if (formatoPlaca && horaValida && minutosValidos) {
                vista.dispose();
                /*DetalleIngreso vistaIngreso = new DetalleIngreso(null, true);
                vistaIngreso.setSize(300, 300);
                vistaIngreso.setLayout(null);
                vistaIngreso.setLocationRelativeTo(null);

                vistaIngreso.plate.setText(obj.getPlaca());
                vistaIngreso.vehicle.setText(obj.getTipo());
                vistaIngreso.hour.setText(obj.getHe()+"");
                vistaIngreso.min.setText(obj.getMe()+"");
